...
public class TranslatableH6 extends H6 implements TranslatableComponent {
    private static final Object[] EMPTY = new Object[0];
    private String translationKey;
    private Object[] translationParameters = EMPTY;

    public TranslatableH6(String translationKey) {
        this.translationKey = translationKey;
        super.setText(getTranslation(translationKey));

    }

    public TranslatableH6(String translationKey, Object... parameters) {
        this.translationKey = translationKey;
